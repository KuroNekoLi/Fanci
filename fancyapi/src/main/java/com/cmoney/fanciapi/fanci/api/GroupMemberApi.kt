...
interface GroupMemberApi {
     ...
     *
     * @param groupId 社團id
     * @param search 搜尋用戶暱稱的關鍵字 (optional)
    ...
    suspend fun apiV1GroupMemberGroupGroupIdGet(@Path("groupId") groupId: kotlin.String, @Query("search") search: kotlin.String? = null, @Query("skip") skip: kotlin.Int? = 0, @Query("take") take: kotlin.Int? = 20): Response<GroupMemberPaging>
